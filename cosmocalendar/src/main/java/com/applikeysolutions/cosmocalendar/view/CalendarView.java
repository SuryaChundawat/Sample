...
public class CalendarView extends RelativeLayout implements OnDaySelectedListener,
    ...
    private void handleAttributes(TypedArray typedArray) {
        ...
        int previousMonthIconRes = typedArray.getResourceId(R.styleable.CalendarView_previousMonthIconRes, R.mipmap.calender_left);
        int nextMonthIconRes = typedArray.getResourceId(R.styleable.CalendarView_nextMonthIconRes, R.mipmap.calender_right);
...
//        flBottomSelectionBar.setLayoutTransition(new LayoutTransition());
    ...
    private void createRangeSelectionLayout() {
        ...
        llRangeSelection.setGravity(LinearLayout.VERTICAL);

...
public class Vedio_Fragment extends Fragment implements View.OnClickListener
{
    ...
    private void Loaddata() {
        ...
        mAdapter = new Adapter_vedio(list,context);
